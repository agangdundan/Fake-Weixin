...
viewshower.addViews([ {
	id : "chats",// 页面的标示
	path : "source://fake-weixin/view/chats/index.ui"// 页面的路径
}, {
	id : "contacts",
	path : "source://fake-weixin/view/contacts/index.ui"
}, {
	id : "discover",
	path : "source://fake-weixin/view/discover/index.ui"
}, {
	id : "me",
	path : "source://fake-weixin/view/me/index.ui"
} ]);
// 初始化先显示第一个页面
...
function showView(name) {
	...
	if (name == "chats") {
		imageview1.source = "source://fake-weixin/image/tabbar_mainframeHL.png";
		label1.fontColor = "09BB07FF";
	} else {
		imageview1.source = "source://fake-weixin/image/tabbar_mainframe.png";
		label1.fontColor = "9F9F9FFF";
	}

	if (name == "contacts") {
		imageview2.source = "source://fake-weixin/image/tabbar_contactsHL.png";
		label2.fontColor = "09BB07FF";
	} else {
		imageview2.source = "source://fake-weixin/image/tabbar_contacts.png";
		label2.fontColor = "9F9F9FFF";
	}

	if (name == "discover") {
		imageview3.source = "source://fake-weixin/image/tabbar_discoverHL.png";
		label3.fontColor = "09BB07FF";
	} else {
		imageview3.source = "source://fake-weixin/image/tabbar_discover.png";
		label3.fontColor = "9F9F9FFF";
	}

	if (name == "me") {
		imageview4.source = "source://fake-weixin/image/tabbar_meHL.png";
		label4.fontColor = "09BB07FF";
	} else {
		imageview4.source = "source://fake-weixin/image/tabbar_me.png";
